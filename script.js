...
const style_subway = "mapbox://styles/amyarussell/cl117odbs001s14nqlm6zttde";
...
const popup = new mapboxgl.Popup({ offset: [0, -15] , className: "my-popup"})
  .setLngLat(feature.geometry.coordinates)
  .setHTML('<h3><a href="' + feature.properties.URL + '">' + feature.properties.PREMISES_R + '</a></h3><h3>' + feature.properties.ADDRESS + '</h3><p> Subway Stop: ' + feature.properties.SUBWAYSTOP + '</p>')
  .addTo(top20); //Add pop up to map
